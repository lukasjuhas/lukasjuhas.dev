...
/* eslint no-param-reassign: ["error", {
  "props": true, "ignorePropertyModificationsFor": ["item"] }]*/
var Manage = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('h4',[_vm._v("Trips:")]),_c('ul',_vm._l((this.items),function(item){return _c('li',[_c('router-link',{attrs:{"to":'/manage/trip/' + item.slug}},[_vm._v(_vm._s(item.title))])],1)}))])},staticRenderFns: [],
  name: 'manage',
