...
const store = {
  ...
  setLoadingAction(newValue) {
    this.debug && log('setLoadingAction triggered with', newValue);
    this.state.loading = newValue;
  },
  clearLoadingAction() {
    this.debug && log('clearLoadingAction triggered');
    this.state.loading = false;
  },
  setFlashAction(option, newValue) {
    this.debug && log(`setFlashAction ${option} triggered with`, newValue);
    this.state.flash[option] = newValue;
  },
  clearFlashAction() {
    this.debug && log('clearFlashAction triggered');
